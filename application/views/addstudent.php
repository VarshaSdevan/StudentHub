                ...
                <div class="card-body">
                  <form action="<?php echo base_url()?>main/studinsert" method="post">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="cast" required="" class="form-control">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text"  name="blood" required="" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Annual income</label>
                          <input type="text" name="income" required="" class="form-control">
                        </div>
                      </div>
                        <div class="col-md-4">
                        <div class="form-group">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="taluk" required="" class="form-control">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="block" required="" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Panchayath</label>
                          <input type="text" name="panchayath" required=""  class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Stream</label>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text"  name="passingdate" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="pgmark" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">UG Mark(%)</label>
                          <input type="text" name="ugmark" class="form-control">
                        </div>
                      </div>
                        <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">HSC Mark(%)</label>
                          <input type="text" name="hsemark"  class="form-control">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="sslcmark"  class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
